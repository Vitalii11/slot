package  com.sot.baseEngine.controllers
{
	...
	import com.sot.baseEngine.customClasses.CustomSound;
	import com.sot.baseEngine.managers.FileManager;
	import com.sot.baseEngine.utils.Utils;
	...
	public class SoundController extends EventDispatcher
	{
		...
		private function onSoundComplete(e:Event):void 
		{
			...
			if (currentSound && _soundGroups[currentSound.group])
			{				
...
//		 * @param	$soundId идентификатор звука который нужно остановить
		 ...
		 */
		public function stopSound($soundId:*, $useFadeOut:Boolean = true, $ignoreSound:* = null, $useCallback:Boolean = false):void
		{
			var soundId:Dictionary = getSoundById($soundId);
			...
			for (var key:String in soundId)
			{
				...
				if (soundStop && _playedSounds[key])
				{
					...
					if (currentSound)
					{
						currentSound.stopSound($useCallback);
