package game.models 
{
	...
	import game.anim.SlotItemAnimation;
	import game.data.ReelData;
	import game.data.SlotItemsData;
	import game.views.SlotItemView;
	...
	public class ReelModel extends BaseModel
	{
		...
		private function lastSpin():void 
		{
			removeTweens();
			updateSpin();
			_tweenLast = TweenMax.to(view, _time + 0.8, {y:view.y + 450, onComplete:completeSpin, ease:Back.easeOut});
		}
